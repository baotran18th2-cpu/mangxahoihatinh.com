...
if 'danh_sach_bai_viet' not in st.session_state:
    st.session_state.danh_sach_bai_viet = [
        ...
        },
        {
            ...
            "binh_luan": [
                {"text": "Jisoo BLACKPINK ✅", "noi_dung": "So cool! Hello Hà Tĩnh! ✨"},
...
st.markdown(f"📍 *Thạch Khê, Hà Tĩnh | 📅 Ngày cập nhật: {datetime.now().strftime('%d/%m/%Y')} | Năm học: 2026 - 2027*")
st.markdown("---")
...
with col1:
    ...
    st.write(
        ...
        "**Học sinh xuất sắc cấp Quốc gia môn Tiếng Anh** trong năm học 2026 - 2027. "
